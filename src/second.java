...
public class second extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					second frame = new second("Qwer","qe","qe","qe","qw","qw","qw");
	 ...
	 * Create the frame.
	 */
	public second(String loginname,String code,String question,String dir,String labname,String labsheet,String quesn) {
		...
		btnCompile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				/* JFileChooser fileChooser=new JFileChooser();
			        if (fileChooser.showSaveDialog(second.this) != JFileChooser.APPROVE_OPTION)
			                    return;
			                File file = fileChooser.getSelectedFile();*/
				//String filename = "H:\\second.c";
				String filename = dir;
				int flag = 0;
                ...
                ProcessBuilder pb=new ProcessBuilder();
                  try {
                    ...
                    if (x == 0) {
                        ...
                        JOptionPane.showMessageDialog(second.this, "Compilation Error", "Error", JOptionPane.ERROR_MESSAGE);
		...
		submitmarks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(connect)
				{
					Connection con = db.getconnection();
					try {
						PreparedStatement stmt = con.prepareStatement("update submitdata SET marks=?,totalmarks=? where username = ? AND labname = ? AND labsheet = ? AND questionno = ?;");
